    ...
    if hands:
        for hand in hands:
            ...
            try:
                ...
                print(f"Predicted Letter: {predicted_label}")  # Show in terminal
                ...
                # Speak the predicted letter using macOS TTS
                os.system(f'say "{predicted_label}"')  # Say the predicted letter
